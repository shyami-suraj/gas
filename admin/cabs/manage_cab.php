	...
	<div class="card-body">
		<form action="" id="cab-form">
            ...
            <div class="form-group">
				<label for="category_id" class="control-label">Place Category</label>
			...
			<div class="form-group">
				<label for="cab_model" class="control-label">Price</label>
			...
			<div class="form-group">
				<label for="body_no" class="control-label"> Gas Model</label>
