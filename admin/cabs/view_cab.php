    ...
    <div class="card card-outline rounded-0 card-purple shadow">
        ...
        <div class="card-body">
            <div class="container">
                ...
                <legend class="h4 text-muted"><b>Vehical Details</b></legend>
                ...
                <fieldset>
                    <legend class="h4 text-muted"><b>Gas Details</b></legend>
                    <div class="row">
                    <div class="col-md-6">
                        <small class="mx-2 text-muted">Place Category</small>
                        <div class="pl-4"><?= isset($category) ? $category : '' ?></div>
                    </div>
                        <div class="col-md-6">
                            <small class="mx-2 text-muted">Price</small>
                            <div class="pl-4">Rs.<?= isset($cab_model) ? $cab_model : '' ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <small class="mx-2 text-muted">Gas Name</small>
