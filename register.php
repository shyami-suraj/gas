      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="contact" id="contact" placeholder="Enter Contact" class="form-control form-control-sm form-control-border" pattern="[0-9]{3}[0-9]{3}[0-9]{4}"  required>
          ...
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="xyz@mail.com" class="form-control form-control-sm form-control-border" required>
