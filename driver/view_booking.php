...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <fieldset class="bor">
                <legend class="h5 text-muted">Gas Details</legend>
                <dl>
                    <dt class="">Gas Name</dt>
                    <dd class="pl-4"><?= isset($body_no) ? $body_no : "" ?></dd>
                    <dt class="">Place Category</dt>
                    <dd class="pl-4"><?= isset($category) ? $category : "" ?></dd>
                    <dt class="">Price</dt>
                    <dd class="pl-4">Rs.<?= isset($cab_model) ? $cab_model : "" ?></dd>
    ...
    <div class="text-right">
        ...
        <button class="btn btn-success btn-flat bg-gradient-success" type="button" id="dropoff_booking">Picked Off</button>
